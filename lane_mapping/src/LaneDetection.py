...
def callback(data):
    ...
    cv_image = bridge.compressed_imgmsg_to_cv2(data, desired_encoding='bgra8')
...
def listener():
    ...
    image_sub = message_filters.Subscriber("/zed/zed_node/left/image_rect_color", CompressedImage, queue_size = 1, buff_size=2**24)
